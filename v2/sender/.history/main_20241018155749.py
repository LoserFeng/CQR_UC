                    ...
                    if qrcode_data!=None:
                        ...
                        if(control_frame_dict!=None):
                            ...
                            if(control_frame_dict['status_code']!=1):
                                ...
                                if(1<<lack_num_len-1)&lack_num==0:
                    ...
                    if(qrcode_img!=None):
                        ...
                        if(control_frame_dict!=None):
                            ...
                            if(control_frame_dict['status_code']==3):
                                ...
                                print(f'receiver show send_rounds:{control_frame_dict["send_rounds"]},{time.time()}')
