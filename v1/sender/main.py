...
class MainUI(Ui_MainWindow, QMainWindow):
    ...
    def send(self,transmission_data):
        ...
        control_frame_img=encoder.generate_control_qrcode(status_code=status,total_frames=len(data_frame_imgs),decoded_frame_dict={})
                ...
                if(status==0):
                    ...
                    if qrcode_data!=None:
                        ...
                        if(control_frame!=None):
                            if(control_frame['status_code']!=1):
                    ...
                    if(qrcode_img!=None):
                        ...
                        if(control_frame!=None):
                            if(control_frame['status_code']==2):
                                ...
                                print(f'receiver show send_rounds:{control_frame["send_rounds"]},{time.time()}')
                                if(send_rounds==control_frame['send_rounds']):
                                    send_data_flag=False
                                    continue
                                ...
                                send_all_data=False
                                send_rounds=control_frame['send_rounds']
                                send_data_flag=True
                                t1=time.time()
                            else:
